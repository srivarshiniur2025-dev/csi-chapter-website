            ...
            <div className="auth-panel__body">
              {!authReady && (
                <div className="auth-alert auth-alert--info">
                  Set <code>VITE_API_URL</code> for Mongo auth, or add Firebase keys from <code>.env.example</code>.
                </div>
              )}
              ...
              <button type="button" className="auth-panel__google" onClick={onGoogle} disabled={busy || !firebaseReady}>
              ...
              <div className="auth-panel__divider">or email</div>
