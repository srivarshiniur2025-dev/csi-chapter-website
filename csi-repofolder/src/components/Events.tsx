...
const eventsData: ChapterEvent[] = [
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1400&auto=format&fit=crop&q=85',
  ...
  },
  {
    ...
    label: 'Robotics',
    image:
      'https://images.unsplash.com/photo-1535378620166-273708f44f1b?w=1400&auto=format&fit=crop&q=85',
    imageAlt: 'Advanced robotics laboratory environment',
    shortDescription:
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1516321318423-f6f367bb8b7c?w=1400&auto=format&fit=crop&q=85',
    imageAlt: 'Futuristic competitive programming arena',
    shortDescription:
...
/** Horizontal offset between cards — tuned to medium-large center card */
const CARD_SPREAD = 400;
const CINEMATIC_EASE = [0.22, 1, 0.36, 1] as const;

function getCardMotion(index: number, activeIndex: number) {
  ...
  if (abs > 2) {
    return {
      ...
      rotateX: 4,
      opacity: 0,
      filter: 'blur(8px) brightness(0.32) saturate(0.75)',
      zIndex: 0,
    };
  }
  ...
  return {
    ...
    filter: isActive
      ? 'blur(0px) brightness(1) saturate(1.02)'
      : abs === 1
        ? 'blur(3px) brightness(0.45) saturate(0.8)'
        : 'blur(5px) brightness(0.35) saturate(0.7)',
...
const Events = () => {
  ...
  const handleStageMove = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
    ...
    setParallax({ x: x * 5, y: y * 2.5 });
    setBannerTilt({ x: x * 4, y: y * 2 });
  }, []);
